...
.. code:: bash
    ...
    $ git clone git@github.com:4teamwork/fontanabau.web.git
    $ cd fontanabau.web
...
- Github: https://github.com/4teamwork/fontanabau.web
- Issues: https://github.com/4teamwork/fontanabau.web/issues
- Continuous integration: https://jenkins.4teamwork.ch/search?q=fontanabau.web
